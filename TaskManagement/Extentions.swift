...
extension UITextView{
    func addAccessoryView(text text:String, sender:AnyObject, action:Selector) {
        let accessoryView = UIView(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.size.width, 44))
        let button = UIButton(frame: CGRectMake(accessoryView.width - 100 - 15, 7, 100, 30))
